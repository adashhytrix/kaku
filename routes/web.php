    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::group([ 
            ...
            Route::group([
                ...
                Route::get('/download-user', [
                    'as' => 'manage.user.userdownload',
                    'uses' => 'ManageUserController@userdownload',
                ]);
                Route::get('/list', [
                    'as' => 'manage.intrest.list',
                    'uses' => 'ManageUserController@intrest',
                ]);
                Route::get('/intrest-add', [
                    'as' => 'manage.intrest.intrestadd',
                    'uses' => 'ManageUserController@intrestadd',
                ]);
                Route::post('/intrest-store', [
                    'as' => 'manage.intrest.intreststore',
                    'uses' => 'ManageUserController@intreststore',
                ]);
                Route::get('/intrest-delete/{id}', [
                    'as' => 'manage.intrest.intrestdelete',
                    'uses' => 'ManageUserController@intrestdelete',
                ]);

                // languages 
                Route::get('/languages-list', [
                    'as' => 'manage.languages.list',
                    'uses' => 'ManageUserController@languageslist',
                ]);

                Route::get('/feedback-list', [
                    'as' => 'manage.feedback.list',
                    'uses' => 'ManageUserController@feedback_list',
                ]);
                Route::get('/languages-add', [
                    'as' => 'manage.language.languageadd',
                    'uses' => 'ManageUserController@languagesadd',
                ]);
                Route::post('/languages-store', [
                    'as' => 'manage.language.languagestore',
                    'uses' => 'ManageUserController@languagestore',
                ]);
                Route::get('/languages-delete/{id}', [
                    'as' => 'manage.language.languagedelete',
                    'uses' => 'ManageUserController@languagedelete',
                ]);

                // musics 
                Route::get('/music-list', [
                    'as' => 'manage.music.list',
                    'uses' => 'ManageUserController@musiclist',
                ]);
                Route::get('/music-add', [
                    'as' => 'manage.music.musicadd',
                    'uses' => 'ManageUserController@musicadd',
                ]);
                Route::post('/music-store', [
                    'as' => 'manage.music.musicstore',
                    'uses' => 'ManageUserController@musicstore',
                ]);
                Route::get('/music-delete/{id}', [
                    'as' => 'manage.music.musicdelete',
                    'uses' => 'ManageUserController@musicdelete',
                ]);

                // lifestyle 
                Route::get('/lifestyle-list', [
                    'as' => 'manage.lifestyle.lifestylelist',
                    'uses' => 'ManageUserController@lifestylelist',
                ]);

                Route::get('/lifestyle-add', [
                    'as' => 'manage.lifestyle.lifestyleadd',
                    'uses' => 'ManageUserController@lifestyleadd',
                ]);
                Route::post('/lifestyle-store', [
                    'as' => 'manage.lifestyle.lifestylestore',
                    'uses' => 'ManageUserController@lifestylstore',
                ]);
                Route::get('/lifestyle-delete/{id}', [
                    'as' => 'manage.lifestyle.lifestyledelete',
                    'uses' => 'ManageUserController@lifestyledelete',
                ]);

                Route::get('/religion-list', [
                    'as' => 'manage.religion.religionlist',
                    'uses' => 'ManageUserController@religionlist',
                ]);
                Route::get('/religion-add', [
                    'as' => 'manage.religion.religionadd',
                    'uses' => 'ManageUserController@religionadd',
                ]);
                Route::post('/religion-store', [
                    'as' => 'manage.religion.religionstore',
                    'uses' => 'ManageUserController@religionstore',
                ]);
                Route::get('/religion-delete/{id}', [
                    'as' => 'manage.religion.religiondelete',
                    'uses' => 'ManageUserController@religiondelete',
                ]);
                // travel
                Route::get('/travel-list', [
                    'as' => 'manage.travel.travellist',
                    'uses' => 'ManageUserController@travellist',
                ]); 
                Route::get('/travel-add', [
                    'as' => 'manage.travel.traveladd',
                    'uses' => 'ManageUserController@traveladd',
                ]); 
                Route::post('/travel-store', [
                    'as' => 'manage.travel.travelstore',
                    'uses' => 'ManageUserController@travelstore',
                ]); 
                Route::get('/travel-delete/{id}', [
                    'as' => 'manage.travel.traveldelete',
                    'uses' => 'ManageUserController@traveldelete',
                ]); 

                // discover 

                Route::get('/discover-list', [
                    'as' => 'manage.discover.discoverlist',
                    'uses' => 'ManageUserController@discoverlist',
                ]); 
                Route::get('/discover-add', [
                    'as' => 'manage.discover.discoveradd',
                    'uses' => 'ManageUserController@discoveradd',
                ]); 
                Route::post('/discover-store', [
                    'as' => 'manage.discover.discoverstore',
                    'uses' => 'ManageUserController@discoverstore',
                ]); 
                Route::get('/discover-delete/{id}', [
                    'as' => 'manage.discover.discoverdelete',
                    'uses' => 'ManageUserController@discoverdelete',
                ]); 

                // relation relation
                Route::get('/relation-list', [
                    'as' => 'manage.relation.relationlist',
                    'uses' => 'ManageUserController@relationlist',
                ]); 
                Route::get('/relation-add', [
                    'as' => 'manage.relation.relationadd',
                    'uses' => 'ManageUserController@relationadd',
                ]); 
                Route::post('/relation-store', [
                    'as' => 'manage.relation.relationstore',
                    'uses' => 'ManageUserController@relationstore',
                ]); 
                Route::get('/relation-delete/{id}', [
                    'as' => 'manage.relation.relationdelete',
                    'uses' => 'ManageUserController@relationdelete',
                ]); 
            ...
            Route::group([
                ...
                Route::get('/discover-index', [
                    'as' => 'manage.configuration.discover',
                    'uses' => 'ConfigurationController@discoverindex',
                ]);
				...
				Route::get('/travel', [ServicesController::class, 'travel'])->name('travel');
