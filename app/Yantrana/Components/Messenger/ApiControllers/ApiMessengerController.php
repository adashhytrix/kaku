...
class ApiMessengerController extends BaseController
{
    ...
    public function searchChatList(Request $request)
{
    
    // Get the search keyword from the request
    $searchKeyword = $request->input('searchKeyword', null);

    // Call the search function and pass the search keyword
    $processReaction = $this->messengerEngine->searchChatListByNickname($searchKeyword);
     ...
     * @return  void
     *-----------------------------------------------------------------------*/
    public function acceptDeclineMessageRequest(Request $request, $userId)
    {
