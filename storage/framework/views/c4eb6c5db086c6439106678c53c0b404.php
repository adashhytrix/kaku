...
<ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <?php
    /*
        <a class="sidebar-brand d-flex align-items-center" href="<?= route('manage.dashboard', ['username' => getUserAuthInfo('profile.username')]) ?>
    ?>">
    */
    ?>
    ...
    */
    ...
    <a class="nav-link lw-ajax-link-action lw-action-with-url"
        href="<?= route('manage.abuse_report.read.list', ['status' => 1]) ?>">
    ...
    */
    ...
    <li class="nav-item lw-settings-sub-menu-items">
        <a class="nav-link lw-ajax-link-action" href="#" data-toggle="collapse" data-target="#collapseUL"
            aria-controls="collapseUL" aria-expanded="false">
            <i class="fas fa-fw fa-cogs"></i>
            <span><?php echo e(__tr('Intrest')); ?></span>
        </a>
        <div id="collapseUL" class="collapse" data-parent="#accordionSidebar">
            <ul class="py-2 mx-3 collapse-inner rounded">
                
                <li class="nav-item ">
                    <a class="nav-link lw-ajax-link-action lw-action-with-url" href="<?php echo e(route('manage.intrest.list')); ?>">
                        <i class="fas fa-users"></i>
                        <span>Intrest</span>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link lw-ajax-link-action lw-action-with-url" href="<?php echo e(route('manage.languages.list')); ?>">
                        <i class="fas fa-users"></i>
                        <span>Languages</span>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link lw-ajax-link-action lw-action-with-url" href="<?php echo e(route('manage.feedback.list')); ?>">
                        <i class="fas fa-users"></i>
                        <span>Feedback</span>
                    </a>
                </li>
    ...
    <li class="nav-item lw-settings-sub-menu-items">
        <a class="nav-link lw-ajax-link-action lw-action-with-url <?= makeLinkActive('manage.configuration.read', $currentRouteName) ?> <?= makeLinkActive('manage.configuration.read', $currentRouteName, '', 'collapsed') ?>"
            href="<?= route('manage.dashboard') ?>" data-toggle="collapse" data-target="#collapseUtilities"
            aria-expanded="<?= trim(makeLinkActive('manage.configuration.read', $currentRouteName, 'true', 'false')) ?>"
            aria-controls="collapseUtilities">
            <i class="fas fa-fw fa-cogs"></i>
            <span><?php echo e(__tr('Settings')); ?></span>
        </a>
        <div id="collapseUtilities"
            class="collapse <?= makeLinkActive('manage.configuration.read', $currentRouteName, 'show') ?>"
            data-parent="#accordionSidebar">
            <div class="py-2 mx-3 collapse-inner rounded">
                <a class="nav-link lw-ajax-link-action lw-action-with-url <?php echo e($pageType == 'general' ? 'active' : ''); ?>"
                    href="<?= route('manage.configuration.read', ['pageType' => 'general']) ?>">
                    <i class="fas fa-wrench"></i>
                    <span><?= __tr('General') ?></span>
                </a>
                <!-- <a class="nav-link lw-ajax-link-action lw-action-with-url <?php echo e($pageType == 'user' ? 'active' : ''); ?>" href="<?= route('manage.configuration.read', ['pageType' => 'user']) ?>">
                    <i class="fas fa-user"></i>
                    <span><?= __tr('Users') ?></span>
                </a> -->
                <!-- Currency & Credit Packages -->
                <!-- <a class="nav-link lw-ajax-link-action lw-action-with-url <?php echo e($pageType == 'currency' ? 'active' : ''); ?>" href="<?= route('manage.configuration.read', ['pageType' => 'currency']) ?>">
                <i class="fas fa-money-bill-alt"></i>
                <span> <?= __tr('Currency') ?></span>
                </a> -->
                <!-- /Currency & Credit Packages -->
                <!-- Payment Settings -->
                <a class="nav-link lw-ajax-link-action lw-action-with-url <?php echo e($pageType == 'payment' ? 'active' : ''); ?>"
                ...
                <a class="nav-link lw-ajax-link-action lw-action-with-url <?php echo e($pageType == 'social-login' ? 'active' : ''); ?>"
                ...
                <a class="nav-link lw-ajax-link-action lw-action-with-url <?php echo e($pageType == 'integration' ? 'active' : ''); ?>"
                    href="<?= route('manage.configuration.read', ['pageType' => 'integration']) ?>">
                    <i class="far fa-sun"></i>
                    <span><?= __tr('Integrations') ?></span>
                </a>
                <!-- /Integration Settings -->
                <!-- Premium Plans Settings -->
                <!-- <a class="nav-link lw-ajax-link-action lw-action-with-url <?php echo e($pageType == 'premium-plans' ? 'active' : ''); ?>"  href="<?= route('manage.configuration.read', ['pageType' => 'premium-plans']) ?>">
                <i class="far fa-gem"></i>
                <span><?= __tr('Premium Plans') ?></span>
            </a> -->
                <!-- /Premium Plans Settings -->
                <!-- Premium Features Settings -->
                <!-- <a class="nav-link lw-ajax-link-action lw-action-with-url <?php echo e($pageType == 'premium-feature' ? 'active' : ''); ?>"  href="<?= route('manage.configuration.read', ['pageType' => 'premium-feature']) ?>">
                <i class="fas fa-database"></i>
                <span> <?= __tr('Features') ?></span>
            </a> -->
                <!-- /Premium Features Settings -->
                <!-- Email Settings -->
                <a class="nav-link lw-ajax-link-action lw-action-with-url <?php echo e($pageType == 'email' ? 'active' : ''); ?>"
                ...
                <!-- /Email Settings -->
                <!-- Booster Settings -->
                <!-- <a class="nav-link lw-ajax-link-action lw-action-with-url <?php echo e($pageType == 'booster' ? 'active' : ''); ?>"  href="<?= route('manage.configuration.read', ['pageType' => 'booster']) ?>">
                <i class="far fa-paper-plane"></i>
                <span><?= __tr('Booster') ?></span>
            </a> -->
                <!-- /Booster Settings -->
                <!-- Advertisement Settings -->
                <!-- <a class="nav-link lw-ajax-link-action lw-action-with-url <?php echo e($pageType == 'advertisement' ? 'active' : ''); ?>"  href="<?= route('manage.configuration.read', ['pageType' => 'advertisement']) ?>">
                <i class="far fa-newspaper"></i>
                <span><?= __tr('Advertisement') ?></span>
            </a> -->
                <!-- /Advertisement Settings -->
                <!-- color settings Settings -->
                <!-- <a class="nav-link lw-ajax-link-action lw-action-with-url <?php echo e($pageType == 'custom-profile-fields' ? 'active' : ''); ?>"  href="<?= route('manage.configuration.read', ['pageType' => 'custom-profile-fields']) ?>">
    ...
    /*
        <li class="nav-item lw-settings-sub-menu-items">
            <a class="nav-link lw-ajax-link-action lw-action-with-url <?= makeLinkActive('manage.configuration.read', $currentRouteName) ?>
    ?> <?= makeLinkActive('manage.configuration.read', $currentRouteName, '', 'collapsed') ?>"
    href="<?= route('manage.dashboard') ?>" data-toggle="collapse" data-target="#collapseUtilities"
    aria-expanded="<?= trim(makeLinkActive('manage.configuration.read', $currentRouteName, 'true', 'false')) ?>"
    aria-controls="collapseUtilities">
    <i class="fas fa-fw fa-cogs"></i>
    <span>{{ __tr('Services') }}</span>
    </a>
    <div id="collapseUtilities"
        class="collapse <?= makeLinkActive('manage.configuration.read', $currentRouteName, 'show') ?>"
        data-parent="#accordionSidebar">
        <div class="py-2 mx-3 collapse-inner rounded">
            <a class="nav-link  {{ $pageType == 'travel' ? 'active' : '' }}" href="{{ route('travel') }}">
                <i class="fas fa-wrench"></i>
                <span><?= __tr('travel') ?></span>
            </a>
            ...
            <!-- /Currency & Credit Packages -->
            <!-- Payment Settings -->
            <a class="nav-link lw-ajax-link-action lw-action-with-url {{ $pageType == 'payment' ? 'active' : '' }}"
                href="<?= route('manage.configuration.read', ['pageType' => 'payment']) ?>">
                <i class="fas fa-credit-card"></i>
                <span> <?= __tr('Payment Gateways') ?></span>
            </a>
            <!-- /Payment Settings -->
            <!-- Social Login Settings -->
            <a class="nav-link lw-ajax-link-action lw-action-with-url {{ $pageType == 'social-login' ? 'active' : '' }}"
                href="<?= route('manage.configuration.read', ['pageType' => 'social-login']) ?>">
                <i class="fas fa-share-alt"></i>
                <span><?= __tr('Social Logins') ?></span>
            </a>
            <!-- /Social Login Settings -->
            <!-- Integration Settings -->
            <a class="nav-link lw-ajax-link-action lw-action-with-url {{ $pageType == 'integration' ? 'active' : '' }}"
                href="<?= route('manage.configuration.read', ['pageType' => 'integration']) ?>">
                <i class="far fa-sun"></i>
                <span><?= __tr('Integrations') ?></span>
            </a>
            ...
            <!-- /Premium Features Settings -->
            <!-- Email Settings -->
            <a class="nav-link lw-ajax-link-action lw-action-with-url {{ $pageType == 'email' ? 'active' : '' }}"
                href="<?= route('manage.configuration.read', ['pageType' => 'email']) ?>">
                <i class="fas fa-envelope-open"></i>
                <span><?= __tr('Email & SMS') ?></span>
            </a>
    ...
    */
    ...
    <li class="nav-item">
        <a class="nav-link" title="<?= __tr("If you have made changes which doesn't reflecting this link may help to
            clear all the cache.") ?>"
            href="<?= route('manage.configuration.clear_cache', []) . '?redirectTo=' . base64_encode(Request::fullUrl()) ?>">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\api-kaku.jurysoft.in (2)\api-kaku.jurysoft.in\resources\views/includes/sidebar.blade.php ENDPATH**/ ?>