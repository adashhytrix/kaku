		...
		<tbody>
			...
			<tr style="font-family: Helvetica, Arial, sans-serif;">
				<td align="center" valign="top" width="100%" style="background-color: #f7f7f7; border-collapse: collapse; color: #777777; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; padding: 20px 0 5px; text-align: center;" class="content-padding">
					<center style="font-family: Helvetica, Arial, sans-serif;">
						<?php if(isset($emailsTemplate)): ?>
						<?php echo $__env->make($emailsTemplate, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
						<?php endif; ?>
						<?php if(isset($emailContent)): ?>
						<?php echo $__env->make($emailContent, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
						<?php endif; ?>
					</center>
				</td>
			</tr>
...
</html><?php /**PATH /home/creden/api-kaku.jurysoft.in/resources/views/emails/index.blade.php ENDPATH**/ ?>