<?php $__env->startSection('page-title', strip_tags($userData['userName'])); ?>
<?php $__env->startSection('head-title', strip_tags($userData['userName'])); ?>
<?php $__env->startSection('page-url', url()->current()); ?>

<?php if(isset($userData['aboutMe'])): ?>
<?php $__env->startSection('keywordName', strip_tags($userProfileData['aboutMe'])); ?>
<?php $__env->startSection('keyword', strip_tags($userProfileData['aboutMe'])); ?>
<?php $__env->startSection('description', strip_tags($userProfileData['aboutMe'])); ?>
<?php $__env->startSection('keywordDescription', strip_tags($userProfileData['aboutMe'])); ?>
<?php endif; ?>

<?php if(isset($userData['profilePicture'])): ?>
<?php $__env->startSection('page-image', $userData['profilePicture']); ?>
<?php endif; ?>
<?php if(isset($userData['coverPicture'])): ?>
<?php $__env->startSection('twitter-card-image', $userData['coverPicture']); ?>
<?php endif; ?>

    <?php if(!request()->ajax()): $__env->startPush('header'); endif; ?>
...
<?php if(!request()->ajax()): $__env->stopPush(); endif; ?>
    <?php if(!request()->ajax()): $__env->startPush('footer'); endif; ?>
...
<div class="lw-contains-profile-fields">
	<div class="card mb-3">
		<div class="card-header">
			...
			<h4>
				<?= $userData['fullName'] ?>
				<?php if(!__isEmpty($userData['userAge'])): ?> (<span data-model="userData.userAge"><?= __tr($userData['userAge']) ?></span>) <?php endif; ?>
				<!-- show user online, idle or offline status -->
				<?php if(!$isOwnProfile): ?>
				<?php if($userOnlineStatus == 1): ?>
				<span class="lw-dot lw-dot-success float-none" title="<?= __tr("Online") ?>"></span>
				<?php elseif($userOnlineStatus == 2): ?>
				<span class="lw-dot lw-dot-warning float-none" title="<?= __tr("Idle") ?>"></span>
				<?php elseif($userOnlineStatus == 3): ?>
				...
				<?php if(getFeatureSettings('premium_badge')): ?>
				<i class="fas fa-star"></i>
				<?php endif; ?>
				<!-- /if user is premium then show badge -->

				<?php if(__ifIsset($userProfileData['isVerified'])
				and $userProfileData['isVerified'] == 1): ?>
				<i class="fas fa-user-check text-info"></i>
				<?php endif; ?>
			</h4>
			<hr>
			<?php if((__ifIsset($userProfileData['city']) and __ifIsset($userProfileData['country_name']))): ?>
                ...
                <div class="card mt-4 lw-profile-side-block">
                    <div class="card-body text-center">
                        ...
                        <div class="lw-like-dislike-box">
                            <!-- like button -->
                            <a href data-action="<?= route('user.write.like_dislike', ['toUserUid' => $userData['userUId'], 'like' => 1]) ?>" data-method="post" data-callback="onLikeCallback" title="<?php echo e(__tr('Like')); ?>" class="lw-ajax-link-action" id="lwLikeBtn">
                        ...
                        <div class="lw-like-dislike-box mb-5">
                            <!-- dislike button -->
                            <a href data-action="<?= route('user.write.like_dislike', ['toUserUid' => $userData['userUId'], 'like' => 0]) ?>" data-method="post" data-callback="onLikeCallback" title="<?php echo e(__tr('Dislike')); ?>" class="lw-ajax-link-action" id="lwDislikeBtn">
                        ...
                        <div class="mt-5">
                            <!-- message button -->
                            <a title="<?php echo e(__tr('Send Message or Gift')); ?>" class=" btn-link btn mb-3" onclick="getChatMessenger('<?= route('user.read.individual_conversation', ['specificUserId' => $userData['userId']]) ?>')" href id="lwMessageChatButton" data-chat-loaded="false" data-toggle="modal" data-target="#messengerDialog"><i class="far fa-comments fa-3x"></i>
                                <br> <?= __tr('Message') ?></a>
                            <!-- send gift button -->
	...
	<?php endif; ?>
	<!-- /mobile view like dislike block -->
	<?php if(isset($userProfileData['aboutMe']) and $userProfileData['aboutMe']): ?>
	<div class="card mb-3">
		<div class="card-header">
	...
	<?php endif; ?>
	<?php if(!__isEmpty($photosData) or $isOwnProfile): ?>
	<div class="card mb-3">
		<div class="card-header">
			<?php if($isOwnProfile): ?>
			<span class="float-right">
		...
		<div class="card-body">
			<div class="row text-center text-lg-left lw-horizontal-container pl-2">
				<?php if(!__isEmpty($photosData)): ?>
				<?php $__currentLoopData = $photosData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	<!-- user gift data -->
	<?php if(!__isEmpty($userGiftData) or $isOwnProfile): ?>
	<div class="card mb-3">
		<!-- Gift Header -->
		<div class="card-header">
		...
		<div class="card-body" id="lwUserGift">
			<?php if(!__isEmpty($userGiftData)): ?>
			<div class="row">
				<?php $__currentLoopData = $userGiftData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	<div class="card mb-3">
		...
		<div class="card-body">
			...
			<div id="lwStaticBasicInformation">
				...
				<?php if(array_get($userProfileData, 'showMobileNumber')): ?>
				<div class="form-group row">
					<!-- Mobile Number -->
					<div class="col-sm-6 mb-3 mb-sm-0">
				...
				<div class="form-group row">
					...
					<div class="col-sm-6 mb-3 mb-sm-0">
						...
						<select name="gender" class="form-control custom-select" id="select_gender">
							...
							<?php $__currentLoopData = $genders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genderKey => $gender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					...
					<div class="col-sm-6">
						...
						<select name="preferred_language" class="form-control custom-select" id="select_preferred_language">
							...
							<?php $__currentLoopData = $preferredLanguages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $languageKey => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				...
				<div class="form-group row">
					...
					<div class="col-sm-6 mb-3 mb-sm-0">
						...
						<select name="relationship_status" class="form-control custom-select" id="select_relationship_status">
							...
							<?php $__currentLoopData = $relationshipStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relationshipStatusKey => $relationshipStatus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					...
					<div class="col-sm-6">
						...
						<select name="work_status" class="form-control custom-select" id="select_work_status">
							...
							<?php $__currentLoopData = $workStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workStatusKey => $workStatus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				...
				<div class="form-group row">
					...
					<div class="col-sm-6 mb-3 mb-sm-0">
						...
						<select name="education" class="form-control custom-select" id="select_education">
							...
							<?php $__currentLoopData = $educations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $educationKey => $educationValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					...
					<div class="col-sm-6">
                        ...
                        <input type="date" min="<?php echo e(getAgeDate(configItem('age_restriction.maximum'), 'max')->format('Y-m-d')); ?>" max="<?php echo e(getAgeDate(configItem('age_restriction.minimum'))->format('Y-m-d')); ?>" class="form-control d-block" name="birthday" placeholder="<?= __tr('DD-MM-YYYY') ?>" value="<?= __ifIsset($userProfileData['dob'], $userProfileData['dob']) ?>" required="true">
					</div>
					<!-- /Birthday -->
				</div>
				<?php if($isOwnProfile): ?>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <div class="input-group">
                            <select name="country_code" class="custom-select form-control lw-country-code-select" id="country_code" required>
                                <option value=""><?php echo e(__tr('Select Country Code')); ?></option>
                                ...
                                <option value="<?= $getCountryCode['phone_code'] ?>" <?= ($userData['country_code'] == $getCountryCode['phone_code']) ? 'selected' : '' ?>><?= $getCountryCode['name'] ?> (0<?php echo e($getCountryCode['phone_code']); ?>)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <input type="number" value="<?php echo e($userData['mobile_number']); ?>" class="form-control lw-remove-spinner" placeholder="<?php echo e(__tr('Mobile Number')); ?>" name="mobile_number" required  minlength="8" maxlength="15">
                          </div>
                   </div>
					<!-- /Mobile Number -->
				</div>
	...
	<div class="card mb-3">
		...
		<div class="card-body">
			...
			<?php if(getStoreSettings('display_google_map')): ?>
				<div class="gmap_canvas"><iframe height="300" id="gmap_canvas" src="https://maps.google.com/maps/place?q=<?= $latitude ?>,<?= $longitude ?>&output=embed&language=<?php echo e(app()->getLocale()); ?>" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
				</div>
			<?php else: ?>
			<div id="staticMapId"></div>
			<?php endif; ?>
			</div>
            <?php if(getStoreSettings('allow_google_map') or getStoreSettings('use_static_city_data')): ?>
			<div id="lwUserEditableLocation" style="display: none;">
			<?php if(getStoreSettings('use_static_city_data')): ?>
				<div class="form-group">
	...
	<!-- User Specifications -->
	<?php if(!__isEmpty($userSpecificationData)): ?>
	<?php $__currentLoopData = $userSpecificationData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specificationKey => $specifications): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	<div class="card mb-3">
		...
		<div class="card-body">
			...
			<div id="lw<?= $specificationKey ?>StaticContainer">
				<?php $__currentLoopData = collect($specifications['items'])->chunk(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specKey => $specification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div class="form-group row">
					<?php $__currentLoopData = $specification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<div class="col-sm-6 mb-3 mb-sm-0">
			...
			<form class="lw-ajax-form lw-form" method="post" lwSubmitOnChange action="<?= route('user.write.profile_setting') ?>" data-callback="getUserProfileData" id="lwUser<?= $specificationKey ?>Form" style="display: none;">
				<?php $__currentLoopData = collect($specifications['items'])->chunk(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div class="form-group row">
					<?php $__currentLoopData = $specification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<div class="col-sm-6 mb-3 mb-sm-0">
						<?php if($item['input_type'] == 'select'): ?>
						...
						<select name="<?= $item['name'] ?>" class="form-control custom-select">
							...
							<?php if(!__isEmpty($item['options'])): ?>
							<?php $__currentLoopData = $item['options']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionKey => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						<?php elseif($item['input_type'] == 'textbox'): ?>
						<label for="<?= $item['name'] ?>"><?= $item['label'] ?></label>
	...
	<div class="modal fade" id="lwSendGiftDialog" tabindex="-1" role="dialog" aria-labelledby="sendGiftModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				...
				<?php if(isset($giftListData) and !__isEmpty($giftListData)): ?>
				...
				<form class="lw-ajax-form lw-form" id="lwSendGiftForm" method="post" data-callback="sendGiftCallback" action="<?= route('user.write.send_gift', ['sendUserUId' => $userData['userUId']]) ?>">
					<div class="modal-body">
						<div class="btn-group-toggle" data-toggle="buttons">
							<?php $__currentLoopData = $giftListData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $gift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php if(getStoreSettings('allow_google_map')): ?>
<script src="https://maps.googleapis.com/maps/api/js?key=<?= getStoreSettings('google_map_key') ?>&libraries=places&callback=initialize&language=<?php echo e(app()->getLocale()); ?>" async defer></script>
<?php endif; ?>
<script>
...
<script>
	...
	function setLocationCoordinates(key, lat, lng, placeData) {
		__DataRequest.post("<?= route('user.write.location_data') ?>", {
			...
			var mapSrc = "https://maps.google.com/maps/place?q=" + lat + "," + lng + "&output=embed&language=<?php echo e(app()->getLocale()); ?>";
			$('#gmap_canvas').attr('src', mapSrc)
		});
	};
	<?php if(!getStoreSettings('allow_google_map') and getStoreSettings('use_static_city_data')): ?>
    ...
    <?php if(request()->ajax()): ?>
        leafLetOptions = {
            icon : L.icon({
            iconUrl: "<?php echo e(asset('dist/css/images/marker-icon.png')); ?>"
        })
    };
    <?php endif; ?>
	// add marker
...
<?php if(!request()->ajax()): $__env->stopPush(); endif; ?><?php /**PATH C:\xampp\htdocs\api-kaku.jurysoft.in (2)\api-kaku.jurysoft.in\resources\views/user/profile.blade.php ENDPATH**/ ?>