...
<nav class="navbar navbar-expand navbar-light bg-dark topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-0">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu p-3 shadow animated--grow-in lw-basic-filter-container" aria-labelledby="searchDropdown">
                <form class="form-inline mr-auto lw-ajax-form lw-action-with-url" method="get" data-title="<?php echo e(__tr('Find Matches')); ?>" data-show-processing="true" action="<?= route('user.read.find_matches') ?>">
                    <!-- Add Name -->
                    ...
                    <div class="lw-looking-for-container lw-basic-filter-field">
                        ...
                        <select name="looking_for" class="form-control custom-select" id="looking_for">
                            ...
                            <?php $__currentLoopData = configItem('user_settings.gender'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genderKey => $gender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="lw-age-between-container lw-basic-filter-field">
                        ...
                        <select name="min_age" class="form-control custom-select" id="min_age">
                            <?php $__currentLoopData = range(18,70); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $age): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <ul class="navbar-nav">
        ...
        <!-- Nav Item - Messages -->
        <li class="nav-item d-none d-sm-none d-md-block">
            <a class="nav-link lw-ajax-link-action lw-action-with-url" href="<?= route('user.credit_wallet.read.view') ?>" data-title="<?php echo e(__tr('Credit Wallet')); ?>">
...
<!-- for image gallery -->
<?php echo $__env->make('includes.image-gallery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    $('#lw-default-featured-users').on('click', function(){
        showConfirmation('', function() {
            ...
            background: '#333',
            popup: 'dark-theme',
            showDenyButton:  <?php if(isPremiumUser()): ?> false <?php else: ?> true <?php endif; ?>,
...
<?php if(!request()->ajax()): $__env->stopPush(); endif; ?><?php /**PATH C:\xampp\htdocs\api-kaku.jurysoft.in (2)\api-kaku.jurysoft.in\resources\views/includes/public-top-bar.blade.php ENDPATH**/ ?>