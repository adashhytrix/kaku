<?php $__env->startSection('page-title', __tr("Manage Users")); ?>
<?php $__env->startSection('head-title', __tr("Manage Users")); ?>
<?php $__env->startSection('keywordName', strip_tags(__tr("Manage Users"))); ?>
<?php $__env->startSection('keyword', strip_tags(__tr("Manage Users"))); ?>
<?php $__env->startSection('description', strip_tags(__tr("Manage Users"))); ?>
<?php $__env->startSection('keywordDescription', strip_tags(__tr("Manage Users"))); ?>
...
<div class="row">
	<div class="col-xl-12">
		...
		<div class="card mb-4">
			...
			<div class="card-body">
				<ul class="nav nav-tabs">
					<!-- Active Tab -->
					<li class="nav-item">
						<a data-title="<?php echo e(__tr('Manage Users: Accepted')); ?>" class="nav-link lw-ajax-link-action lw-action-with-url nav-link <?= $userStatus == 1 ? 'active' : '' ?>"
					...
					<!-- Inactive Tab -->
					<li class="nav-item">
						<a data-title="<?php echo e(__tr('Manage Users: Inactive')); ?>" class="nav-link lw-ajax-link-action lw-action-with-url nav-link <?= $userStatus == 2 ? 'active' : '' ?>"
					...
					<!-- Deleted Tab -->
					<li class="nav-item">
						<a data-title="<?php echo e(__tr('Manage Users: Deleted')); ?>" class="nav-link lw-ajax-link-action lw-action-with-url nav-link <?= $userStatus == 5 ? 'active' : '' ?>"
					...
					<!-- Never Activated Tab -->
					<li class="nav-item">
						<a data-title="<?php echo e(__tr('Manage Users: Never Activated')); ?>" class="nav-link lw-ajax-link-action lw-action-with-url nav-link <?= $userStatus == 4 ? 'active' : '' ?>"
					...
					<!-- Blocked Tab -->
					<li class="nav-item">
						<a data-title="<?php echo e(__tr('Manage Users: Blocked')); ?>" class="nav-link lw-ajax-link-action lw-action-with-url nav-link <?= $userStatus == 3 ? 'active' : '' ?>"
							href="<?= route('manage.user.view_list', ['status' => 3]) ?>">
							<?= __tr('Blocked') ?>
						</a>
					</li>
					<li class="nav-item">
						<a  target="_blank" class="nav-link  nav-link"
							href="<?php echo e(route('manage.user.userdownload')); ?>">
							<?= __tr('Download') ?>
						</a>
					</li>
					<!-- /Blocked Tab -->
		...
		<% if(__tData.is_verified == 1) { %> &nbsp;&nbsp;&nbsp;<i class="fas fa-user-check text-info" title="<?php echo e(__tr('Verified User')); ?>"></i> <% } %> <% if(__tData.is_fake == 1) { %><i class="fas fa-user-secret" title="<?php echo e(__tr('Fake User')); ?>"></i> <% } %>
		...
		<% if(__tData.is_fake == 1) { %>
			<!-- admin Login Button -->
			<a href class="" data-toggle="modal" data-user-uid='<%= __tData._uid %>'  data-user-id="<%=__tData._id%>" data-target="#adminLoginDialog" data-user-name="<%= __tData.full_name %>"><i class="fas fa-sign-in-alt text-secondary" title="<?php echo e(__tr('Login')); ?>"></i></a>
			<!-- /admin Login Button -->
		<% } %>
		<!-- /show premium badge if user is premium -->
	</div>
							...
							<div class="col-sm-6 mb-3 mb-sm-0">
								...
								<div class="input-group mt-1">
									...
									<select name="country_code" class="form-control lw-country-code-select custom-select" id="country_code" required>
										<option value=""><?php echo e(__tr('Select Code')); ?></option>
...
<script>
   ...
   //user edit modal data
	var countryCodeList = <?php echo json_encode(getCountryPhoneCodes(), 15, 512) ?>;
...
<?php if(!request()->ajax()): $__env->stopPush(); endif; ?><?php /**PATH C:\xampp\htdocs\api-kaku.jurysoft.in (2)\api-kaku.jurysoft.in\resources\views/user/manage/list.blade.php ENDPATH**/ ?>