...
<ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    */
    ...
    {{-- <li class="nav-item ">
        <a class="nav-link lw-ajax-link-action lw-action-with-url" href="{{ route('manage.intrest.list') }}">
            <i class="fas fa-users"></i>
            <span>Intrest</span>
        </a>
    </li>
    <li class="nav-item ">
        <a class="nav-link lw-ajax-link-action lw-action-with-url" href="{{ route('manage.languages.list') }}">
            <i class="fas fa-users"></i>
            <span>Languages</span>
        </a>
    </li>
    <li class="nav-item ">
        <a class="nav-link lw-ajax-link-action lw-action-with-url" href="{{ route('manage.music.list') }}">
            <i class="fas fa-users"></i>
            <span>Music</span>
        </a>
    </li>
    <li class="nav-item ">
        <a class="nav-link lw-ajax-link-action lw-action-with-url" href="{{ route('manage.lifestyle.lifestylelist') }}">
            <i class="fas fa-users"></i>
            <span>Lifestyle</span>
        </a>
    </li> --}}
    {{-- <li class="nav-item ">
        <a class="nav-link lw-ajax-link-action lw-action-with-url" href="{{ route('manage.religion.religionlist') }}">
            <i class="fas fa-users"></i>
            <span>Religion</span>
        </a>
    </li>
    <li class="nav-item ">
        <a class="nav-link lw-ajax-link-action lw-action-with-url" href="{{ route('manage.travel.travellist') }}">
            <i class="fas fa-users"></i>
            <span>Travel</span>
        </a>
    </li>
    <li class="nav-item ">
        <a class="nav-link lw-ajax-link-action lw-action-with-url" href="{{ route('manage.discover.discoverlist') }}">
            <i class="fas fa-users"></i>
            <span>Discover</span>
        </a>
    </li>
    <li class="nav-item ">
        <a class="nav-link lw-ajax-link-action lw-action-with-url" href="{{ route('manage.relation.relationlist') }}">
            <i class="fas fa-users"></i>
            <span>Relation</span>
        </a>
    </li> --}}
    ...
    <li class="nav-item lw-settings-sub-menu-items">
        ...
        <div id="collapseUL" class="collapse" data-parent="#accordionSidebar">
            <ul class="py-2 mx-3 collapse-inner rounded">
                ...
                <li class="nav-item ">
                    <a class="nav-link lw-ajax-link-action lw-action-with-url" href="{{ route('manage.feedback.list') }}">
                        <i class="fas fa-users"></i>
                        <span>Feedback</span>
                    </a>
                </li>
    ...
    <li class="nav-item lw-settings-sub-menu-items">
        ...
        <div id="collapseUtilities"
            ...
            <div class="py-2 mx-3 collapse-inner rounded">
                <a class="nav-link lw-ajax-link-action lw-action-with-url {{ $pageType == 'general' ? 'active' : '' }}"
    ...
    */
    ...
    {{-- <li class="nav-item">
        ...
        <a class="nav-link" title="<?= __tr('Get Discover Item Here') ?>"
            href="<?= route('manage.configuration.discover', []) . '?redirectTo=' . base64_encode(Request::fullUrl()) ?>">
            <i class="fas fa-broom"></i>
            <span><?= __tr('Add Discover') ?></span>
        </a>
    </li> --}}
